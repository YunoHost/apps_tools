...
- [ ] Better define danger level.
	- Maybe use CVSS classification (severity note out of 10) in security.toml instead of "danger"?
	- Include EPSS classification (probability of exploitation) for more accuracy?
	...
	- Mixing CVSS and EPSS could hep: 
		- Filtering out low-risk vulnerabilities with high CVSS but low EPSS
		- Prioritizing high-risk vulnerabilities with moderate CVSS but high EPSS
